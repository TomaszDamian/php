<nav class="flex items-center justify-between flex-wrap bg-teal p-6">
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div class="text-sm lg:flex-grow">
      <a href="/Sources" class="block mr-4 mt-4 lg:inline-block lg:mt-0 text-teal-lighter hover:text-white ">
        Sources
      </a>
      <a href="/MyBlogWall" class="block mt-4 lg:inline-block lg:mt-0 text-teal-lighter hover:text-white mr-4">
        My Blogs Wall
      </a>
